...
WebUI.click(findTestObject('Object Repository/Page_Login/div_PasswordShowForgot username or password'))
...
WebUI.click(findTestObject('Object Repository/Page_Care Tuner/li_Bart SimpsonChange'))
...
WebUI.click(findTestObject('Object Repository/Page_Care Tuner/img'))

WebUI.click(findTestObject('Object Repository/Page_Care Tuner/li_Lisa SimpsonChange'))
